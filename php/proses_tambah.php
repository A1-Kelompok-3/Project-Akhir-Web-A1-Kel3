...
//cek dulu jika ada gambar treatment jalankan coding ini
if($gambar != "") {
  ...
  $nama_gambar_baru = $angka_acak.'-'.$gambar; //menggabungkan angka acak dengan nama file sebenarnya
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {     
                move_uploaded_file($file_tmp, '../img/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                  ...
                  $query = "INSERT INTO layanan (treatment, description, estimasi, harga, gambar) VALUES ('$treatment', '$description', '$estimasi', '$harga', '$nama_gambar_baru')";
